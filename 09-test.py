...
async def main():
    ...
    xpath = '//*[@id="ignore-gpu-blocklist"]'
    await manager.hover(xpath)
    xpath = 'select[data-internal-name="ignore-gpu-blocklist"]'
    text = 'Enabled'
    await manager.setvalue(xpath, text)

    xpath = '//*[@id="disable-accelerated-2d-canvas"]'
    await manager.hover(xpath)
    xpath = 'select[data-internal-name="disable-accelerated-2d-canvas"]'
    text = 'Disabled'
    await manager.setvalue(xpath, text)

    xpath = '//*[@id="show-autofill-type-predictions"]'
    await manager.hover(xpath)
    xpath = 'select[data-internal-name="show-autofill-type-predictions"]'
    text = 'Disabled'
    await manager.setvalue(xpath, text)

    xpath = '//*[@id="smooth-scrolling"]'
    await manager.hover(xpath)
    xpath = 'select[data-internal-name="smooth-scrolling"]'
    text = 'Disabled'
    await manager.setvalue(xpath, text)

    xpath = '//*[@id="enable-gpu-rasterization"]'
    await manager.hover(xpath)
    xpath = 'select[data-internal-name="enable-gpu-rasterization"]'
    text = 'Enabled'
    await manager.setvalue(xpath, text)

    xpath = '//*[@id="disable-accelerated-video-decode"]'
    await manager.hover(xpath)
    xpath = 'select[data-internal-name="disable-accelerated-video-decode"]'
    text = 'Disabled'
    await manager.setvalue(xpath, text)
    ...
    xpath = '//*[@id="back-forward-cache"]'
    await manager.hover(xpath)
    xpath = 'select[data-internal-name="back-forward-cache"]'
    text = 'Disabled'
    await manager.setvalue(xpath, text)

    xpath = '//*[@id="overscroll-history-navigation"]'
    await manager.hover(xpath)
    xpath = 'select[data-internal-name="overscroll-history-navigation"]'
    text = 'Disabled'
    await manager.setvalue(xpath, text)

    xpath = '//*[@id="disable-accelerated-video-encode"]'
    await manager.hover(xpath)
    xpath = 'select[data-internal-name="disable-accelerated-video-encode"]'
    text = 'Disabled'
    await manager.setvalue(xpath, text)
